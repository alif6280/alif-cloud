...
export default function LoginPage() {
  ...
  const typed = useTyping(["INITIALIZING SECURE SESSION...", "ENCRYPTING CHANNEL AES-256...", "IDENTITY VERIFICATION REQUIRED", "SYSTEM ACCESS TERMINAL READY"]);
      ...
      <div style={{ width: "100%", maxWidth: 440, position: "relative", zIndex: 10 }}>
        ...
        <div style={{ background: "rgba(0,12,4,0.96)", border: "1px solid rgba(0,255,65,0.2)", borderTop: "none", borderRadius: "0 0 12px 12px", padding: "2rem 2rem 1.75rem", backdropFilter: "blur(20px)", boxShadow: "0 0 60px rgba(0,255,65,0.08), 0 30px 80px rgba(0,0,0,0.8)", position: "relative" }}>
          ...
          <div style={{ textAlign: "center", marginBottom: "1.75rem" }}>
            <div style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 64, height: 64, borderRadius: 14, border: "1px solid rgba(0,255,65,0.25)", background: "rgba(0,255,65,0.05)", marginBottom: "1rem", boxShadow: "0 0 20px rgba(0,255,65,0.1)" }}>
            ...
            <div style={{ fontSize: "1.6rem", fontWeight: 700, letterSpacing: "0.18em", fontFamily: "monospace", color: "#00ff41", textShadow: "0 0 15px rgba(0,255,65,0.7), 0 0 30px rgba(0,255,65,0.3)", marginBottom: "0.4rem" }}>ALIF.CLOUD</div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "0.5rem 0.875rem", marginBottom: "1.25rem", background: "rgba(0,255,65,0.03)", border: "1px solid rgba(0,255,65,0.1)", borderRadius: 6 }}>
            ...
            <span style={{ fontFamily: "monospace", fontSize: "0.68rem", color: "rgba(0,255,65,0.55)", letterSpacing: "0.05em" }}>SECURE_CHANNEL :: AES-256-GCM :: TLS 1.3</span>
          </div>
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: "1rem" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="user@domain.com" required
                  style={{ width: "100%", padding: "0.7rem 1rem 0.7rem 2rem", background: "rgba(0,255,65,0.04)", border: "1px solid rgba(0,255,65,0.18)", borderRadius: 7, color: "#00ff41", fontFamily: "monospace", fontSize: "0.875rem", outline: "none", caretColor: "#00ff41", boxSizing: "border-box", transition: "all 0.2s" }}
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type={showPass ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••••••" required
                  style={{ width: "100%", padding: "0.7rem 2.75rem 0.7rem 2rem", background: "rgba(0,255,65,0.04)", border: "1px solid rgba(0,255,65,0.18)", borderRadius: 7, color: "#00ff41", fontFamily: "monospace", fontSize: "0.875rem", outline: "none", caretColor: "#00ff41", boxSizing: "border-box", transition: "all 0.2s" }}
                  onFocus={e => { e.target.style.borderColor = "rgba(0,255,65,0.5)"; e.target.style.background = "rgba(0,255,65,0.07)"; e.target.style.boxShadow = "0 0 0 3px rgba(0,255,65,0.07)"; }}
                  onBlur={e => { e.target.style.borderColor = "rgba(0,255,65,0.18)"; e.target.style.background = "rgba(0,255,65,0.04)"; e.target.style.boxShadow = "none"; }}
                />
            ...
            >
              {loading ? <><Loader2 style={{ width: 15, height: 15, animation: "spin 0.7s linear infinite" }} /> AUTHENTICATING...</> : <><Lock style={{ width: 14, height: 14 }} /> [ EXECUTE_LOGIN ]</>}
            </button>
          </form>

          <div style={{ textAlign: "center", marginTop: "1.25rem" }}>
            <p style={{ fontFamily: "monospace", fontSize: "0.65rem", color: "rgba(0,255,65,0.2)", letterSpacing: "0.06em", marginBottom: "0.5rem" }}>// AUTHORIZED PERSONNEL ONLY</p>
            <p style={{ fontFamily: "monospace", fontSize: "0.68rem", color: "rgba(0,255,65,0.35)" }}>NO_ACCOUNT?{" "}<a href="/signup" style={{ color: "rgba(0,255,65,0.7)", textDecoration: "none", borderBottom: "1px solid rgba(0,255,65,0.3)" }}>[ REQUEST_ACCESS ]</a></p>
          </div>
        </div>
      </div>
